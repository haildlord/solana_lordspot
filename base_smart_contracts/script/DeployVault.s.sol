...
contract DeployVault is Script { 
    function run() external {
        ...
        uint256 ownerPrivateKey =
            0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80;     // ANVIL 1st PRIMARY Key
        address owner = vm.addr(ownerPrivateKey);                                   // 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
        ...
        address megapotAddress = vm.envAddress("MEGAPOT_BASE_ADDRESS");             // 0x3bAe643002069dBCbcd62B1A4eb4C4A397d042a2
        address usdcAddress = vm.envAddress("USDC_BASE_ADDRESS");                   // 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913
